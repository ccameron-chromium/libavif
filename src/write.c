...
static avifBool avifWriteToneMappedImagePayload(avifRWData * data, const avifGainMapMetadata * metadata)
{
    ...
    const uint16_t minimum_version = 0;
    AVIF_CHECKRES(avifRWStreamWriteU16(&s, minimum_version));
    const uint16_t writer_version = 0;
    AVIF_CHECKRES(avifRWStreamWriteU16(&s, writer_version));
